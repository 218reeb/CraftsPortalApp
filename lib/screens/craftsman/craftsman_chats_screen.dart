...
class CraftsmanChatsScreen extends StatefulWidget {
  const CraftsmanChatsScreen({super.key});

  @override
  State<CraftsmanChatsScreen> createState() => _CraftsmanChatsScreenState();
}

class _CraftsmanChatsScreenState extends State<CraftsmanChatsScreen> {
  @override
  void initState() {
    super.initState();
    _loadChats();
